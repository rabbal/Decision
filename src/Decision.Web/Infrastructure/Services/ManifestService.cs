...
namespace Decision.Web.Infrastructure.Services
{
    public class ManifestService : IManifestService
    {
        ...
        public ManifestService(UrlHelper urlHelper,IAppConfiguration configuration)
        {
        ...
        public string GetManifestJson()
        {
            var document = new JObject(
                new JProperty("short_name", _configuration.SiteShortName),
                new JProperty("name", _configuration.SiteName),
                new JProperty("icons",
                    new JArray(
