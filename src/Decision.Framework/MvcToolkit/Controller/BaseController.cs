...
namespace Decision.Framework.MvcToolkit.Controller
{
    ...
    public abstract class BaseController : System.Web.Mvc.Controller
    {
        ...
        protected HttpStatusCodeResult HttpInternalServerError() => HttpInternalServerError((string)null);

        protected HttpStatusCodeResult HttpBadRequest() => HttpBadRequest((string)null);
