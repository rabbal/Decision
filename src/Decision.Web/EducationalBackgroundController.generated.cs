...
{
    public partial class EducationalBackgroundController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected EducationalBackgroundController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public EducationalBackgroundController Actions { get { return MVC.EducationalBackground; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "educationalbackground";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "educationalbackground";
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string _EducationalBackgroundItem = "_EducationalBackgroundItem";
                public readonly string _ListAjax = "_ListAjax";
                public readonly string Edit = "Edit";
                public readonly string List = "List";
            }
            public readonly string _Create = "~/Views/EducationalBackground/_Create.cshtml";
            public readonly string _EducationalBackgroundItem = "~/Views/EducationalBackground/_EducationalBackgroundItem.cshtml";
            public readonly string _ListAjax = "~/Views/EducationalBackground/_ListAjax.cshtml";
            public readonly string Edit = "~/Views/EducationalBackground/Edit.cshtml";
            public readonly string List = "~/Views/EducationalBackground/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_EducationalBackgroundController : Decision.Web.Controllers.EducationalBackgroundController
    {
        public T4MVC_EducationalBackgroundController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void ListAjaxOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.EducationalBackground.EducationalBackgroundSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ListAjax(Decision.ViewModel.EducationalBackground.EducationalBackgroundSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ListAjax);
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.EducationalBackground.AddEducationalBackgroundViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Decision.ViewModel.EducationalBackground.AddEducationalBackgroundViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.EducationalBackground.EditEducationalBackgroundViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Decision.ViewModel.EducationalBackground.EditEducationalBackgroundViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
