...
{
    public partial class AppraiserController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected AppraiserController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AppraiserController Actions { get { return MVC.Appraiser; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "appraiser";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "appraiser";
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _AppraiserItem = "_AppraiserItem";
                public readonly string _Create = "_Create";
                public readonly string _Edit = "_Edit";
                public readonly string _ListAjax = "_ListAjax";
                public readonly string List = "List";
            }
            public readonly string _AppraiserItem = "~/Views/Appraiser/_AppraiserItem.cshtml";
            public readonly string _Create = "~/Views/Appraiser/_Create.cshtml";
            public readonly string _Edit = "~/Views/Appraiser/_Edit.cshtml";
            public readonly string _ListAjax = "~/Views/Appraiser/_ListAjax.cshtml";
            public readonly string List = "~/Views/Appraiser/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AppraiserController : Decision.Web.Controllers.AppraiserController
    {
        public T4MVC_AppraiserController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void ListAjaxOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.Appraiser.AppraiserSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ListAjax(Decision.ViewModel.Appraiser.AppraiserSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ListAjax);
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.Appraiser.AddAppraiserViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Decision.ViewModel.Appraiser.AddAppraiserViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.Appraiser.EditAppraiserViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Decision.ViewModel.Appraiser.EditAppraiserViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
