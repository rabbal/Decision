...
{
    public partial class WorkExperienceController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected WorkExperienceController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public WorkExperienceController Actions { get { return MVC.WorkExperience; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "workexperience";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "workexperience";
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string _WorkExperienceItem = "_WorkExperienceItem";
                public readonly string List = "List";
            }
            public readonly string _Create = "~/Views/WorkExperience/_Create.cshtml";
            public readonly string _Edit = "~/Views/WorkExperience/_Edit.cshtml";
            public readonly string _ListAjax = "~/Views/WorkExperience/_ListAjax.cshtml";
            public readonly string _WorkExperienceItem = "~/Views/WorkExperience/_WorkExperienceItem.cshtml";
            public readonly string List = "~/Views/WorkExperience/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_WorkExperienceController : Decision.Web.Controllers.WorkExperienceController
    {
        public T4MVC_WorkExperienceController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void ListAjaxOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.WorkExperience.WorkExperienceSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ListAjax(Decision.ViewModel.WorkExperience.WorkExperienceSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ListAjax);
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.WorkExperience.AddWorkExperienceViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Decision.ViewModel.WorkExperience.AddWorkExperienceViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.WorkExperience.EditWorkExperienceViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Decision.ViewModel.WorkExperience.EditWorkExperienceViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
