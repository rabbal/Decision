...
{
    public partial class FavoriteIssueController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected FavoriteIssueController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public FavoriteIssueController Actions { get { return MVC.FavoriteIssue; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "favoriteissue";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "favoriteissue";
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string _FavoriteIssueItem = "_FavoriteIssueItem";
                public readonly string _ListAjax = "_ListAjax";
                public readonly string List = "List";
            }
            public readonly string _Create = "~/Views/FavoriteIssue/_Create.cshtml";
            public readonly string _Edit = "~/Views/FavoriteIssue/_Edit.cshtml";
            public readonly string _FavoriteIssueItem = "~/Views/FavoriteIssue/_FavoriteIssueItem.cshtml";
            public readonly string _ListAjax = "~/Views/FavoriteIssue/_ListAjax.cshtml";
            public readonly string List = "~/Views/FavoriteIssue/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_FavoriteIssueController : Decision.Web.Controllers.FavoriteIssueController
    {
        public T4MVC_FavoriteIssueController() : base(Dummy.Instance) { }
