...
namespace Decision.ServiceLayer.Interfaces
{
    public interface ISettingService
    {
        ...
        /// </summary>
        /// <typeparam name="T">Type</typeparam>
        Task<T> LoadSetting<T>() where T : ISetting, new();
        ...
        Task SaveSetting<T>(T settings) where T : ISetting, new();
        ...
        /// </summary>
        /// <typeparam name="T">Type</typeparam>
        Task DeleteSetting<T>() where T : ISetting, new();
