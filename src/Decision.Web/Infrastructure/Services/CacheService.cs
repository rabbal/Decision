...
namespace Decision.Web.Infrastructure.Services
{
    ...
    public sealed class CacheService : ICacheService
    {
        ...
        /// </summary>
        public long Count => HttpRuntime.Cache.Count;
        ...
        private static IEnumerable<string> GetAllCachedKeys()
        {
            ...
            Action<string, T> beforeItemRemoved) where T : class
        {
            ...
            HttpRuntime.Cache.Add(
                ...
                value,
                null,
                cacheItemPolicy.AbsoluteExpiration.DateTime,
