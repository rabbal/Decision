...
{
    public partial class ResearchExperienceController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ResearchExperienceController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ResearchExperienceController Actions { get { return MVC.ResearchExperience; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "researchexperience";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "researchexperience";
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string _ResearchExperienceItem = "_ResearchExperienceItem";
                public readonly string List = "List";
            }
            public readonly string _Create = "~/Views/ResearchExperience/_Create.cshtml";
            public readonly string _Edit = "~/Views/ResearchExperience/_Edit.cshtml";
            public readonly string _ListAjax = "~/Views/ResearchExperience/_ListAjax.cshtml";
            public readonly string _ResearchExperienceItem = "~/Views/ResearchExperience/_ResearchExperienceItem.cshtml";
            public readonly string List = "~/Views/ResearchExperience/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ResearchExperienceController : Decision.Web.Controllers.ResearchExperienceController
    {
        public T4MVC_ResearchExperienceController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void ListAjaxOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.ResearchExperience.ResearchExperienceSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ListAjax(Decision.ViewModel.ResearchExperience.ResearchExperienceSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ListAjax);
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.ResearchExperience.AddResearchExperienceViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Decision.ViewModel.ResearchExperience.AddResearchExperienceViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.ResearchExperience.EditResearchExperienceViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Decision.ViewModel.ResearchExperience.EditResearchExperienceViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
