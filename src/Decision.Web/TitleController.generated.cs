...
namespace Decision.Web.Controllers
{
    public partial class TitleController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> IsEnableCategory()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.IsEnableCategory);
            return System.Threading.Tasks.Task.FromResult(callInfo as ActionResult);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string IsEnableCategory = ("IsEnableCategory").ToLowerInvariant();
        ...
        static readonly ActionParamsClass_IsEnableCategory s_params_IsEnableCategory = new ActionParamsClass_IsEnableCategory();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_IsEnableCategory IsEnableCategoryParams { get { return s_params_IsEnableCategory; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_IsEnableCategory
        {
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string _TitleItem = "_TitleItem";
                public readonly string List = "List";
            }
            public readonly string _Create = "~/Views/Title/_Create.cshtml";
            public readonly string _Edit = "~/Views/Title/_Edit.cshtml";
            public readonly string _ListAjax = "~/Views/Title/_ListAjax.cshtml";
            public readonly string _TitleItem = "~/Views/Title/_TitleItem.cshtml";
            public readonly string List = "~/Views/Title/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_TitleController : Decision.Web.Controllers.TitleController
    {
        ...
        [NonAction]
        partial void ListAjaxOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.Title.TitleSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ListAjax(Decision.ViewModel.Title.TitleSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ListAjax);
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.Title.AddTitleViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Decision.ViewModel.Title.AddTitleViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.Title.EditTitleViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Decision.ViewModel.Title.EditTitleViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
        ...
        [NonAction]
        partial void IsEnableCategoryOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.DomainClasses.Entities.Common.TitleType type);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> IsEnableCategory(Decision.DomainClasses.Entities.Common.TitleType type)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.IsEnableCategory);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "type", type);
            IsEnableCategoryOverride(callInfo, type);
            return System.Threading.Tasks.Task.FromResult(callInfo as ActionResult);
        }
