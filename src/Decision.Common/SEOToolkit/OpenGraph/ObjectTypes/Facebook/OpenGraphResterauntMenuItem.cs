...
namespace Decision.Common.SEOToolkit.OpenGraph.ObjectTypes.Facebook
{
    ...
    public class OpenGraphResterauntMenuItem : OpenGraphMetadata
    {
        ...
        /// <param name="sectionUrl">
        ///     The URL to the page about the section this menu item is from. This URL must contain profile
        ///     meta tags <see cref="OpenGraphResterauntMenuSection" />.
        /// </param>
            ...
            : base(title, image, url)
        {
            if (sectionUrl == null)
            {
                throw new ArgumentNullException(nameof(sectionUrl));
            }
        ...
        public override void ToString(StringBuilder stringBuilder)
        {
            ...
            if (Variations != null)
            {
                foreach (var variation in Variations)
                {
                    ...
                    stringBuilder.AppendMetaPropertyContent("restaurant:variation:price:currency",
        ...
        /// <summary>
        ///     Gets the URL to the page about the section this menu item is from. This URL must contain profile meta tags
