namespace Decision.Common.SEOToolkit.OpenGraph.Enums
{
    /// <summary>
    ///     An Open Graph type.
    /// </summary>
    public enum OpenGraphType
    {
        ...
        /// <summary>
        ///     This object represents a single author of a book. This object type is not part of the Open Graph standard but is
        ///     used by Facebook.
        ...
        /// <summary>
        ///     This object represents a single book or publication. This is an appropriate type for ebooks, as well as traditional
        ...
        /// <summary>
        ///     This object type represents a specific achievement in a game. An app must be in the 'Games' category in App
        ///     Dashboard to be able to use this
        ///     object type. Every achievement has a game:points value associate with it. This is not related to the points the
        ///     user has scored in the game, but
        ///     is a way for the app to indicate the relative importance and scarcity of different achievements: * Each game gets a
        ///     total of 1,000 points to
        ///     distribute across its achievements * Each game gets a maximum of 1,000 achievements * Achievements which are
        ///     scarcer and have higher point
        ///     values will receive more distribution in Facebook's social channels. For example, achievements which have point
        ///     values of less than 10 will get
        ///     almost no distribution. Apps should aim for between 50-100 achievements consisting of a mix of 50 (difficult), 25
        ///     (medium), and 10 (easy) point
        ///     value achievements Read more on how to use achievements in this guide. This object type is not part of the Open
        ///     Graph standard but is used by
        ///     Facebook.
        ...
        /// <summary>
        ///     This object represents a music album; in other words, an ordered collection of songs from an artist or a collection
        ///     of artists. An album can
        ...
        /// <summary>
        ///     This object represents a 'radio' station of a stream of audio. The audio properties should be used to identify the
        ///     location of the stream itself.
        ///     This object type is part of the Open Graph standard.
        ///     See http://ogp.me/
        ...
        /// <summary>
        ///     This object type represents a group of product items. This object type is not part of the Open Graph standard but
        ///     is used by Facebook.
        ...
        /// <summary>
        ///     This object type represents a person. While appropriate for celebrities, artists, or musicians, this object type
        ///     can be used for the profile of
