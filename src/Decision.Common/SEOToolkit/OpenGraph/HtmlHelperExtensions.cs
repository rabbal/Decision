...
namespace Decision.Common.SEOToolkit.OpenGraph
{
    /// <summary>
    ...
    public static class HtmlHelperExtensions
    {
        ...
        /// <summary>
        ///     Creates a string containing the Open Graph meta tags (Also used by Facebook). <see cref="OpenGraphMetadata" /> for
        ///     more information.
        /// </summary>
        ...
        /// <summary>
        ///     Creates a <see cref="string" /> representing the Open Graph, Facebook and object namespaces. The namespaces are
