...
namespace Decision.Framework.Experimental.ObjectPool
{
    /// <summary>
    ///     Copied from Microsoft Roslyn code at
    ///     http://source.roslyn.codeplex.com/#Microsoft.CodeAnalysis.Workspaces/Utilities/ObjectPools/SharedPools.cs,b2114905209e7df3
    ...
    public static class SharedPools
    {
        ...
        {
            var list = Default<List<object>>().AllocateAndClear();

            Default<List<object>>().Free(list);
        ...
        /// <summary>
        ///     A pool of dictionaries of type <see cref="Dictionary{TKey, TValue}" /> with StringComparer.OrdinalIgnoreCase as key
        ///     comparer, up to a maximum of 20 instances.
        /// </summary>
        /// <typeparam name="T">The type of the values in the dictionary.</typeparam>
        private static class StringIgnoreCaseDictionaryNormalPool<T>
        {
            /// <summary>
            ///     The pool of dictionaries of type <see cref="Dictionary{TKey, TValue}" /> with StringComparer.OrdinalIgnoreCase as
            ///     key comparer, up to a maximum of 20 instances.
            /// </summary>
