...
namespace Decision.Framework.Extensions
{
    public static class DateTimeExtensions
    {
        ...
        {
            return new PersianDateTime(datetime).ToString(format).GetPersianNumbers();
        }

        public static string ToPersianTimeString(this DateTime datetime)
        {
            return new PersianDateTime(datetime).ToString("hh:mm:ss tt").GetPersianNumbers();
        }

        public static string ToPersianString(this DateTime? datetime, PersianDateTimeFormat format)
        {
            return datetime != null
                ? new PersianDateTime(datetime.Value).ToString(format).GetPersianNumbers()
                : string.Empty;
        }
        ...
        {
            return datetime != null
                ? new PersianDateTime(datetime.Value).ToString("hh:mm:ss tt").GetPersianNumbers()
                : string.Empty;
        }

        public static string ToRemainingDateTime(this DateTime dateTime)
        {
            return RemainingDateTime.Calculate(dateTime).GetPersianNumbers();
        }
        ...
        public static DateTime GetEvenHourDate(this DateTime? dateTime)
        {
            ...
            var d = dateTime.Value.AddHours(1);
