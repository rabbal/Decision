namespace Decision.Web.Infrastructure.Constants
{
    public static class ContentDeliveryNetwork
    {
        ...
        public static class MaxCdn
        {
            ...
            public const string FontAwesomeUrl = "//maxcdn.bootstrapcdn.com/font-awesome/4.6.1/css/font-awesome.min.css";
        }

        public static class Microsoft
        {
            public const string Domain = "ajax.aspnetcdn.com";
            public const string JQueryUrl = "//ajax.aspnetcdn.com/ajax/jQuery/jquery-2.2.3.min.js";
            public const string SignalrScriptUrl = "//ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.min.js";
