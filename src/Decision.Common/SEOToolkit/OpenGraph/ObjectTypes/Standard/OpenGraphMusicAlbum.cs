...
namespace Decision.Common.SEOToolkit.OpenGraph.ObjectTypes.Standard
{
    ...
    public class OpenGraphMusicAlbum : OpenGraphMetadata
    {
        ...
        /// <param name="songUrls">
        ///     The URL's to the pages about the songs on this album. This URL must contain profile meta tags
        ...
        /// <summary>
        ///     Gets or sets the URL's to the pages about the musicians who wrote the song. This URL must contain profile meta tags
        ...
        /// <summary>
        ///     Gets or sets the type of the release of the album. This is a Facebook specific property and not specified by the
        ///     Open Graph standard.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the URL's to the pages about the songs on this album. This URL must contain profile meta tags
        ///     <see cref="OpenGraphMusicSong" />.
        /// </summary>
