...
namespace Decision.Common.SEO.OpenGraph.ObjectTypes.Facebook
{
    ...
    public class OpenGraphRestaurantMenu : OpenGraphMetadata
    {
        ...
        /// <param name="restaurantUrl">
        ///     The URL to the page about the restaurant who wrote the menu. This URL must contain profile
        ///     meta tags <see cref="OpenGraphRestaurant" />.
        /// </param>
        ...
        public override void ToString(StringBuilder stringBuilder)
        {
            ...
            stringBuilder.AppendMetaPropertyContent("restaurant:restaurant", RestaurantUrl);
        ...
        /// <summary>
        ///     Gets the URL to the page about the restaurant who wrote the menu. This URL must contain profile meta tags
        ///     <see cref="OpenGraphRestaurant" />.
        /// </summary>
        ...
        ///     <see cref="OpenGraphRestaurantMenuSection" />.
        /// </summary>
