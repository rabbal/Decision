...
namespace Decision.Common.SEO.OpenGraph.ObjectTypes.Standard
{
    ...
    public class OpenGraphProfile : OpenGraphMetadata
    {
        ...
        public override void ToString(StringBuilder stringBuilder)
        {
            ...
            stringBuilder.AppendMetaPropertyContentIfNotNull("profile:first_name", FirstName);
            stringBuilder.AppendMetaPropertyContentIfNotNull("profile:last_name", LastName);
            stringBuilder.AppendMetaPropertyContentIfNotNull("profile:username", Username);

            if (Gender.HasValue)
            {
                stringBuilder.AppendMetaPropertyContent("profile:gender", Gender.Value.ToLowercaseString());
            }
        }
