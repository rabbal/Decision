...
namespace Decision.Framework.ReflectionToolkit
{
    /// <summary>
    ...
    public class PropertyReflector
    {
        ...
        /// The target and propertyName parameters can't be null.
        /// </summary>
        /// <param name="target">todo: describe target parameter on SetValue</param>
        /// <param name="propertyName">todo: describe propertyName parameter on SetValue</param>
        /// <param name="value">todo: describe value parameter on SetValue</param>
        ...
        /// </summary>
        /// <param name="propertyName">todo: describe propertyName parameter on GetBestMatchingProperty</param>
        /// <param name="type">todo: describe type parameter on GetBestMatchingProperty</param>
        ...
        /// </summary>
        /// <param name="targetObjectType">todo: describe targetObjectType parameter on CalculateDistance</param>
        /// <param name="baseType">todo: describe baseType parameter on CalculateDistance</param>
