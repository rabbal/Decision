...
namespace Decision.Common.SEOToolkit.OpenGraph.ObjectTypes.Standard
{
    ...
    public class OpenGraphBook : OpenGraphMetadata
    {
        ...
        public override void ToString(StringBuilder stringBuilder)
        {
            ...
            stringBuilder.AppendMetaPropertyContentIfNotNull("book:author", AuthorUrl);
            stringBuilder.AppendMetaPropertyContentIfNotNull("book:isbn", ISBN);
            stringBuilder.AppendMetaPropertyContentIfNotNull("book:release_date", ReleaseDate);
            stringBuilder.AppendMetaPropertyContentIfNotNull("book:tag", Tags);
        }
        ...
        /// <summary>
        ///     Gets or sets the URL to the page about the author who wrote the book. This URL must contain profile meta tags
        ...
        /// <summary>
        ///     Gets the type of your object, e.g. "video.movie". Depending on the type you specify, other properties may also be
        ///     required.
        /// </summary>
