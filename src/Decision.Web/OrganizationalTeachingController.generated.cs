...
{
    public partial class OrganizationalTeachingController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected OrganizationalTeachingController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public OrganizationalTeachingController Actions { get { return MVC.OrganizationalTeaching; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "organizationalteaching";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "organizationalteaching";
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string _OrganizationalTeachingItem = "_OrganizationalTeachingItem";
                public readonly string List = "List";
            }
            public readonly string _Create = "~/Views/OrganizationalTeaching/_Create.cshtml";
            public readonly string _Edit = "~/Views/OrganizationalTeaching/_Edit.cshtml";
            public readonly string _ListAjax = "~/Views/OrganizationalTeaching/_ListAjax.cshtml";
            public readonly string _OrganizationalTeachingItem = "~/Views/OrganizationalTeaching/_OrganizationalTeachingItem.cshtml";
            public readonly string List = "~/Views/OrganizationalTeaching/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_OrganizationalTeachingController : Decision.Web.Controllers.OrganizationalTeachingController
    {
        public T4MVC_OrganizationalTeachingController() : base(Dummy.Instance) { }
