...
using Decision.Framework.SEO.Twitter.Enums;
using Decision.Framework.SEO.Twitter.Structs;

namespace Decision.Framework.SEO.Twitter.Cards
{
    /// <summary>
    ///     Video clips and audio streams have a special place on the Twitter platform thanks to the Player Card. By
    ///     implementing a few HTML meta tags to
    ///     your website and following the Twitter Rules of the Road, you can deliver your rich media to users across the
    ///     globe.
    ...
    public class PlayerTwitterCard : TwitterCard
    {
        ...
        /// <summary>
        ///     Gets the video player. If the iframe is wider than 435px, the iframe player will be resized to fit a max width of
        ///     435px, maintaining the original aspect ratio.
        /// </summary>
