...
{
    public partial class TrainingCenterController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected TrainingCenterController(Dummy d) { }
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> GetCenters()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GetCenters);
            return System.Threading.Tasks.Task.FromResult(callInfo as ActionResult);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TrainingCenterController Actions { get { return MVC.TrainingCenter; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "trainingcenter";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "trainingcenter";
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string GetCenters = ("GetCenters").ToLowerInvariant();
        ...
        static readonly ActionParamsClass_GetCenters s_params_GetCenters = new ActionParamsClass_GetCenters();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_GetCenters GetCentersParams { get { return s_params_GetCenters; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_GetCenters
        {
            public readonly string id = ("id").ToLowerInvariant();
        }
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string _TrainingCenterItem = "_TrainingCenterItem";
                public readonly string List = "List";
            }
            public readonly string _Create = "~/Views/TrainingCenter/_Create.cshtml";
            public readonly string _Edit = "~/Views/TrainingCenter/_Edit.cshtml";
            public readonly string _ListAjax = "~/Views/TrainingCenter/_ListAjax.cshtml";
            public readonly string _TrainingCenterItem = "~/Views/TrainingCenter/_TrainingCenterItem.cshtml";
            public readonly string List = "~/Views/TrainingCenter/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_TrainingCenterController : Decision.Web.Controllers.TrainingCenterController
    {
        public T4MVC_TrainingCenterController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void ListAjaxOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.TrainingCenter.TrainingCenterSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ListAjax(Decision.ViewModel.TrainingCenter.TrainingCenterSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ListAjax);
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.TrainingCenter.AddTrainingCenterViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Decision.ViewModel.TrainingCenter.AddTrainingCenterViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.TrainingCenter.EditTrainingCenterViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Decision.ViewModel.TrainingCenter.EditTrainingCenterViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
        ...
        [NonAction]
        partial void GetCentersOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string id);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> GetCenters(string id)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GetCenters);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
            GetCentersOverride(callInfo, id);
            return System.Threading.Tasks.Task.FromResult(callInfo as ActionResult);
        }
