...
public static partial class MVC
{
    ...
    public static Decision.Web.Controllers.AdoptedPriorityController AdoptedPriority = new Decision.Web.Controllers.T4MVC_AdoptedPriorityController();
    public static Decision.Web.Controllers.AppraiserController Appraiser = new Decision.Web.Controllers.T4MVC_AppraiserController();
    public static Decision.Web.Controllers.ArticleController Article = new Decision.Web.Controllers.T4MVC_ArticleController();
    public static Decision.Web.Controllers.ArticleEvaluationController ArticleEvaluation = new Decision.Web.Controllers.T4MVC_ArticleEvaluationController();
    ...
    public static Decision.Web.Controllers.FavoriteIssueController FavoriteIssue = new Decision.Web.Controllers.T4MVC_FavoriteIssueController();
    public static Decision.Web.Controllers.HomeController Home = new Decision.Web.Controllers.T4MVC_HomeController();
    public static Decision.Web.Controllers.InstitutionController Institution = new Decision.Web.Controllers.T4MVC_InstitutionController();
    ...
    public static Decision.Web.Controllers.OrganizationalTeachingController OrganizationalTeaching = new Decision.Web.Controllers.T4MVC_OrganizationalTeachingController();
