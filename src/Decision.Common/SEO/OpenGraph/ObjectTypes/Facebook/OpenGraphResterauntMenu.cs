...
namespace Decision.Common.SEO.OpenGraph.ObjectTypes.Facebook
{
    ...
    public class OpenGraphResterauntMenu : OpenGraphMetadata
    {
        ...
        /// <param name="resterauntUrl">
        ///     The URL to the page about the resteraunt who wrote the menu. This URL must contain profile
        ///     meta tags <see cref="OpenGraphResteraunt" />.
        /// </param>
            ...
            : base(title, image, url)
        {
            ...
            {
                throw new ArgumentNullException(nameof(resterauntUrl));
            }

            ResterauntUrl = resterauntUrl;
        }
        ...
        public override void ToString(StringBuilder stringBuilder)
        {
            ...
            stringBuilder.AppendMetaPropertyContent("restaurant:restaurant", ResterauntUrl);
        ...
        /// <summary>
        ///     Gets the URL to the page about the resteraunt who wrote the menu. This URL must contain profile meta tags
        ///     <see cref="OpenGraphResteraunt" />.
        /// </summary>
        public string ResterauntUrl { get; }

        /// <summary>
        ///     Gets or sets the URL's to the pages about the menu sections. This URL must contain restaurant.section meta tags
        ///     <see cref="OpenGraphResterauntMenuSection" />.
        /// </summary>
