...
namespace Decision.Common.SEO.OpenGraph.ObjectTypes.Standard
{
    ...
    public class OpenGraphArticle : OpenGraphMetadata
    {
        ...
        public override void ToString(StringBuilder stringBuilder)
        {
            ...
            stringBuilder.AppendMetaPropertyContentIfNotNull("article:author", AuthorUrls);
            ...
            stringBuilder.AppendMetaPropertyContentIfNotNull("article:publisher", PublisherUrl);
        ...
        /// <summary>
        ///     Gets or sets the URL's to the pages about the author who wrote the article. This URL must contain profile meta tags
        ...
        /// <summary>
        ///     Gets or sets the URL to the page about the publisher of the article. This URL must contain profile the meta tag
        ///     <see cref="OpenGraphProfile" />.
