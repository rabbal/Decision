...
namespace Decision.Web.Controllers
{
    public partial class AddressController
    {
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _AddressItem = "_AddressItem";
                public readonly string _Create = "_Create";
                public readonly string _Edit = "_Edit";
                public readonly string _ListAjax = "_ListAjax";
                public readonly string List = "List";
            }
            public readonly string _AddressItem = "~/Views/Address/_AddressItem.cshtml";
            public readonly string _Create = "~/Views/Address/_Create.cshtml";
            public readonly string _Edit = "~/Views/Address/_Edit.cshtml";
            public readonly string _ListAjax = "~/Views/Address/_ListAjax.cshtml";
            public readonly string List = "~/Views/Address/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AddressController : Decision.Web.Controllers.AddressController
    {
        ...
        [NonAction]
        partial void ListAjaxOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.Address.AddressSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> ListAjax(Decision.ViewModel.Address.AddressSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ListAjax);
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.Address.AddAddressViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Decision.ViewModel.Address.AddAddressViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Decision.ViewModel.Address.EditAddressViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Decision.ViewModel.Address.EditAddressViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
