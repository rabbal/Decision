...
namespace Decision.Framework.MvcToolkit.Providers
{
    /// <summary>
    ...
    public class SecureTempDataProvider : ITempDataProvider
    {
        ...
        static string SerializeWithJsonFormatter(IDictionary<string, object> data)
        {
            if (data == null || data.Keys.Count == 0) return null;
        ...
        static IDictionary<string, object> DeserializeWithJsonFormatter(string data)
        {
