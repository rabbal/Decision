...
{
    public partial class ScientificTeachingController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ScientificTeachingController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ScientificTeachingController Actions { get { return MVC.ScientificTeaching; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "scientificteaching";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "scientificteaching";
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string _ScientificTeachingItem = "_ScientificTeachingItem";
                public readonly string List = "List";
            }
            public readonly string _Create = "~/Views/ScientificTeaching/_Create.cshtml";
            public readonly string _Edit = "~/Views/ScientificTeaching/_Edit.cshtml";
            public readonly string _ListAjax = "~/Views/ScientificTeaching/_ListAjax.cshtml";
            public readonly string _ScientificTeachingItem = "~/Views/ScientificTeaching/_ScientificTeachingItem.cshtml";
            public readonly string List = "~/Views/ScientificTeaching/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ScientificTeachingController : Decision.Web.Controllers.ScientificTeachingController
    {
        public T4MVC_ScientificTeachingController() : base(Dummy.Instance) { }
