...
{
    public partial class AdoptedPriorityController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected AdoptedPriorityController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AdoptedPriorityController Actions { get { return MVC.AdoptedPriority; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "adoptedpriority";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "adoptedpriority";
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _AdoptedPriorityItem = "_AdoptedPriorityItem";
                public readonly string _Create = "_Create";
                public readonly string _Edit = "_Edit";
                public readonly string _ListAjax = "_ListAjax";
                public readonly string List = "List";
            }
            public readonly string _AdoptedPriorityItem = "~/Views/AdoptedPriority/_AdoptedPriorityItem.cshtml";
            public readonly string _Create = "~/Views/AdoptedPriority/_Create.cshtml";
            public readonly string _Edit = "~/Views/AdoptedPriority/_Edit.cshtml";
            public readonly string _ListAjax = "~/Views/AdoptedPriority/_ListAjax.cshtml";
            public readonly string List = "~/Views/AdoptedPriority/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AdoptedPriorityController : Decision.Web.Controllers.AdoptedPriorityController
    {
        public T4MVC_AdoptedPriorityController() : base(Dummy.Instance) { }
