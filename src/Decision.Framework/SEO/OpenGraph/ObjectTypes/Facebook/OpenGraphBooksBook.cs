...
namespace Decision.Framework.SEO.OpenGraph.ObjectTypes.Facebook
{
    ...
    public class OpenGraphBooksBook : OpenGraphMetadata
    {
        ...
        public override void ToString(StringBuilder stringBuilder)
        {
            ...
            stringBuilder.AppendMetaPropertyContentIfNotNull("books:genre", GenreUrls);
            stringBuilder.AppendMetaPropertyContentIfNotNull("books:initial_release_date", InitialReleaseDate);
            stringBuilder.AppendMetaPropertyContentIfNotNull("books:isbn", ISBN);
            stringBuilder.AppendMetaPropertyContentIfNotNull("books:language", Language);
            stringBuilder.AppendMetaPropertyContentIfNotNull("books:page_count", PageCount);

            if (Rating != null)
            {
                stringBuilder.AppendMetaPropertyContent("books:rating:value", Rating.Value);
                stringBuilder.AppendMetaPropertyContent("books:rating:scale", Rating.Scale);
            }

            stringBuilder.AppendMetaPropertyContentIfNotNull("books:release_date", ReleaseDate);
            stringBuilder.AppendMetaPropertyContentIfNotNull("books:sample", SampleUrl);
        }
        ...
        /// <summary>
        ///     Gets or sets the URL's to the pages about the authors of the book. This URL must contain books.author meta tags
        ///     <see cref="OpenGraphBooksAuthor" />.
        /// </summary>
        public IEnumerable<string> AuthorUrls { get; set; }

        /// <summary>
        ///     Gets or sets the URL's to the pages about the genres of the book. This URL must contain books.genre meta tags
        ///     <see cref="OpenGraphBooksGenre" />.
        /// </summary>
