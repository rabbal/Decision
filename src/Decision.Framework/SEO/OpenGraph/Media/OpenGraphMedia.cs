...
namespace Decision.Framework.SEO.OpenGraph.Media
{
    /// <summary>
    ...
    public abstract class OpenGraphMedia
    {
        ...
        /// <summary>
        ///     Gets or sets the MIME type of the media e.g. media/jpeg. This is optional if your media URL ends with a file
        ///     extension,
